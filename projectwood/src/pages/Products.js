...
export default function Products() {
  ...
  return (
    ...
    <div className=" grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 ">
      <Product img={"/unsalon.png"} title={"Salon"} date={"12-12-2033"} desc={"Enhance your salon space with our meticulously crafted wooden furniture. From sleek coffee tables to cozy lounge chairs, our salon collection offers a perfect blend of comfort and style. Immerse yourself in the warmth of natural wood, creating a welcoming and inviting atmosphere for gatherings and relaxation."} />
      <Product img="/meuble.png" title="Meuble" date={"12-12-2033"} desc={"Explore our exclusive meubles collection, where functionality meets aesthetic appeal. Each piece is a testament to the artistry of wood craftsmanship, bringing a touch of sophistication to your living spaces. From chic bookshelves to versatile storage solutions, our meubles seamlessly integrate into your home, offering both practicality and design."} />
      <Product img="/livingroom.png" title="Livin groom" date={"12-12-2033"} desc={"Elevate your living room with our handcrafted wooden accents, designed to transform ordinary spaces into extraordinary ones. Embrace the beauty of nature with our unique coffee tables, sideboards, and decorative shelves. Imbue your living room with a sense of warmth and character that only high-quality wood products can provide."} />
      <Product img="/kitchen2.png" title="kitchen" date={"12-12-2033"} desc={"Revolutionize your kitchen aesthetics with our range of wooden essentials. From elegant dining tables to functional storage solutions, our kitchen collection combines style and utility. Experience the joy of cooking and dining in a space adorned with the timeless beauty of wood, creating a harmonious blend of functionality and visual appeal."}  />
      <Product img="/kitchen.png" title="kitchen" date={"12-12-2033"} desc={"Revolutionize your kitchen aesthetics with our range of wooden essentials. From elegant dining tables to functional storage solutions, our kitchen collection combines style and utility. Experience the joy of cooking and dining in a space adorned with the timeless beauty of wood, creating a harmonious blend of functionality and visual appeal."} />
      </div>
